...
4. `governance-commons/passes/dev-accord/DEV-ACCORD.02.md` — execution model: PASS, RUN, Evidence Bundle (governing doctrine for all planned work)
5. `projects.yaml` — the registry and pointers to each project's canonical plan
6. The specific project's `DEV-PATH.md` and `DEV-PLAN.md`
