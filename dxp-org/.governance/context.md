...
`dxp-org` is the local Developer Experience Platform workspace root. It coordinates multiple project repos, including the DevX Control Plane, DevXToolkit v1, DevXToolkit v2, and governance packages.
...
- `devxtoolkit-v1-x` is the active runnable DevXToolkit v1 implementation.
...
- **DevXToolkit v1 is canonical for implementation** - v2 stays scaffold-only until a migration plan exists.
